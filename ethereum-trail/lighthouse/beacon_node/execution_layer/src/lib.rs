...
pub enum BlockProposalContents<E: EthSpec, Payload: AbstractExecPayload<E>> {
    Payload {
        payload: Payload,
        block_value: Uint256,
        trail_block_evidence: Option<serde_json::Value>,
    },
    PayloadAndBlobs {
        payload: Payload,
        block_value: Uint256,
...
impl<E: EthSpec, Payload: AbstractExecPayload<E>> BlockProposalContents<E, Payload> {
    ...
    pub fn trail_block_evidence(&self) -> Option<serde_json::Value> {
        match self {
            Self::Payload {
                trail_block_evidence,
                ..
