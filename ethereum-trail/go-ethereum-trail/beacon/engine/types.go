...
type ExecutableData struct {
	...
	TrailSettlementRecords []types.TrailSettlementRecord `json:"trailSettlementRecords,omitempty"`
}
...
type ExecutionPayloadEnvelope struct {
	...
	TrailBlockEvidence json.RawMessage `json:"trailBlockEvidence,omitempty"`
}
...
func ExecutableDataToBlockNoHash(data ExecutableData, versionedHashes []common.Hash, beaconRoot *common.Hash, requests [][]byte) (*types.Block, error) {
	...
	return types.NewBlockWithHeader(header).
			WithBody(types.Body{
				...
				TrailSettlementRecords: data.TrailSettlementRecords,
			}).
...
func BlockToExecutableData(block *types.Block, fees *big.Int, sidecars []*types.BlobTxSidecar, requests [][]byte) *ExecutionPayloadEnvelope {
	data := &ExecutableData{
		...
		TrailSettlementRecords: block.TrailSettlementRecords(),
	}
