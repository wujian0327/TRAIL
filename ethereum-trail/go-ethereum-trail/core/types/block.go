...
type Body struct {
	...
	TrailSettlementRecords []TrailSettlementRecord `rlp:"optional"`
}

// TrailSettlementRecord is a devnet-only execution-payload extension used to
// carry finalized fee settlement inputs with the block body.
type TrailSettlementRecord struct {
...
type Block struct {
	...
	trailSettlementRecords []TrailSettlementRecord
...
func NewBlock(header *Header, body *Body, receipts []*Receipt, hasher ListHasher) *Block {
	...
	var (
		...
		trailSettlementRecords = body.TrailSettlementRecords
	)
	...
	b.trailSettlementRecords = slices.Clone(trailSettlementRecords)
...
func (b *Block) DecodeRLP(s *rlp.Stream) error {
	...
	b.trailSettlementRecords = eb.TrailSettlementRecords
...
func (b *Block) EncodeRLP(w io.Writer) error {
	return rlp.Encode(w, &extblock{
		...
		TrailSettlementRecords: b.trailSettlementRecords,
	})
}
...
func (b *Block) TrailSettlementRecords() []TrailSettlementRecord {
	return b.trailSettlementRecords
}
...
func (b *Block) WithBody(body Body) *Block {
	block := &Block{
		...
		trailSettlementRecords: slices.Clone(body.TrailSettlementRecords),
		witness:                    b.witness,
	}
