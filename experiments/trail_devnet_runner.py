#!/usr/bin/env python3
"""Run reproducible TRAIL topology workloads against a Kurtosis devnet."""
...
def main() -> None:
    ...
    collect = sub.add_parser("collect", help="Collect block-inline path records and TRAIL metrics")
